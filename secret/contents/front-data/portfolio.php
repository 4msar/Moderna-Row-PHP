<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-users"></i> Projects</h1>
          ...
          <div class="tile ">
                <div class="tile-title">
                    ...
                    <div class="button-group btn-group-sm float-right">
						<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addModal"><i class="fa fa-plus-circle"></i> Add New Project</button>
                      ...
                      <thead class="table_head">
                        ...
                        <tbody>
                          ...
                          <tr>
                                ...
                                <td><?php echo substr($data['details'], 0, 80); ?>...</td>
    ...
    function delete_confirm(id)
      ...
      var r=confirm("Do you really want to delete?");
        if (r==true)
        {
          window.location="index.php?action=delete_p&did="+id+"&u=front-end&get=portfolio";
        }
      }
    </script>
</main>
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <form action="index.php?u=front-end&get=portfolio" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
            ...
            <br>
            <input class="form-control icon-pick" type="file" accept="image/*" name="image" placeholder="Icon" required="required">
            <br>
            
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <input type="submit" name="add_portfolio" class="btn btn-primary" value="Save">
        </div>
      </form>
    </div>
  </div>
      ...
      <div class="modal-content">
        ...
        <form action="" method="post">
	        ...
	        <div class="modal-footer">
	          ...
	          <button class="btn btn-success" onclick="return add_cat('add_portfolio_cat')" id="cat_sub">Add</button>
        	</div>
        </form>
      </div>
    </div>
